...
<hr>
<div align="left" style="position: relative; padding: 10px; display: inline-block;">
    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; border-radius: 10px; background: linear-gradient(90deg, pink, blue); z-index: -1;"></div>
    <div style="border: 2px solid transparent; border-radius: 10px; padding: 10px; background: white;">
